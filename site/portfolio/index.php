...
<html>
    ...
    <body>
        ...
        <section id="portfolioHero" class="websitesHero">
            <h1>WEBSITES</h1>
        </section>

        <section id="portfolioAbout">
            <p>Need a custom website design? All of our websites are build custom in-house to ensure that each website is built to match the look and brand of the company. Our design ensures our customers recieve a modern looking website that also maximizes conversion rates.</p>
            <h2>DESIGN PORTFOLIO</h2>
        </section>

        <section id="portfolioImg">
            <div class="portfolioWrap">
                <span class="atreo"><a href="http://www.atreo.ca"><button type="button" name="button">VISIT SITE</button></a></span>
                <span class="verona"><a href="/veronaSite/"><button type="button" name="button">VISIT SITE</button></a></span>
            </div>
        </section>
